              ...
              <div className="panel">
                ...
                >
                  {jobListings.map((job, index) => (
                    <div key={index}>
                      <div className="panel vstack justify-end items-end gap-1 p-3 rounded lg:rounded-2 bg-white text-black border border-white">
                        <div className="vstack gap-narrow">
                          <h5 className="h6 lg:h5 text-black m-0">{job.title}</h5>
                          <span className="fs-6 text-dark  text-opacity-70">
                            {job.location}
                          </span>
                        </div>
                        <Link
