      ...
      <div className="section-outer panel py-6 xl:py-9 bg-tertiary-300 dark:bg-primary-700 bg-gradient-to-b from-transparent via-transparent to-white dark:to-black dark:bg-opacity-15">
        <div className="container max-w-lg">
          <div className="section-inner panel">
            ...
            >
              <div>
                <h2 className="h4 sm:h3 lg:h2 text-center">
                  Our Executive Team
                </h2>
                <p className="fs-5 xl:fs-4 text-opacity-70 text-center">
                  Meet the builders, dreamers, and late-night coders who turn ideas into empires.
                </p>
              </div>
